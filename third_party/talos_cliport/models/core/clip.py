...
from talos_cliport.utils.simple_tokenizer import SimpleTokenizer as _Tokenizer
...
def _download(url: str, root: str = os.path.expanduser("~/.cache/clip")):
    raise RuntimeError("Use scripts/fetch_clip_backbone.py; implicit downloads are disabled.")
