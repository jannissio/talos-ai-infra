# Selected upstream source; see ../UPSTREAM.json and LICENSE files.
import torch
import torch.nn as nn
import torch.nn.functional as F

import talos_cliport.utils.utils as utils
from talos_cliport.models.resnet import IdentityBlock, ConvBlock
from talos_cliport.support import UpsampleMerge as Up
from talos_cliport.models.core.clip import build_model, load_clip, tokenize

from talos_cliport.models.core import fusion
from talos_cliport.models.core.fusion import FusionConvLat
...
class CLIPLingUNetLat(nn.Module):
    ...
    def _load_clip(self):
        from talos_cliport.support import shared_backbone
        self.clip_rn50 = shared_backbone(self.cfg['clip_checkpoint_path'], self.device)
