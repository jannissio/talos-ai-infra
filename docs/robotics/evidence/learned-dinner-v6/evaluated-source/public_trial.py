...
def run_trial(instruction, seed=42, controller='learned', bottle_start='upright',
              camera='opposite', *, suite=None, cache_dir=None, max_wall_seconds=300, cancel_event=None):
    ...
    try:
        ...
        if controller == 'learned':
            ...
            task = LearnedDinnerSequence(model, data, layout, checkpoints, visual_plan['steps'])
