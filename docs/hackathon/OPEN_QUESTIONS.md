...
| --- | --- | --- | --- |
| High | Reconcile final hardware wording | PDF page 3 has a strict Core Ultra 2/3 sentence, but livestream lines 63–65 explicitly say other Intel iGPU systems qualify and Ultra earns bonus points. This PC has an i7-10850H and Intel UHD. | Test local Intel CPU/iGPU execution; obtain written confirmation of the spoken clarification. No longer treat newer hardware as a confirmed access blocker. See [review](LIVESTREAM_REVIEW_2026-09-11.md). |
