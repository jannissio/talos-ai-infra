...
The [post-update cloud regression](../robotics/evidence/composed-dinner-v1/cloud-cpu-headroom-seed42.json) passes all seven steps at revision `c08e96f493e76f38f06143fa621c3cf01da29b25`: 283.31 simulated / **305.33 wall seconds**, with every per-skill physical check re-read from the browser report. This exceeds the previous 300-second allowance and fits within the new 420-second allowance. All model and physical-threshold bytes remain unchanged.
