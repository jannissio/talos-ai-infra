...
- [Submission form guide](https://lablab.ai/ai-articles/hackathon-guidelines) and the authenticated Talos entry form, September 13. Basic information is saved; required video/PDF media gates access to the next form step. No final submission has been made.
...
| R10 | Public GitHub and judge-access/demo URL | Private HF Space running. GPU bottle/cancel pass; shared GPU allocation fails intermittently after 60 seconds. OpenVINO CPU is now default and full cloud sequence is running | Verify full hosted sequence, then anonymous access at final public release |
...
| D4 | Continuous visual correction | Unfinished in deployed baseline. New fixed cameras and custom CNN observer implemented; first fit misses its 3 mm p95 gate; expanded data training active | Observer accuracy/occlusion gate, recovery demonstrations, neural correction, and paired live/frozen-image physical tests |
