...
| R10 | Public GitHub and judge-access/demo URL | Private HF Space passes all six learned tasks on CPU: 247.655 simulated / 273.03 wall seconds, exposed seed 42. Shared GPU allocation remains intermittent | Anonymous access and judge usability at final public release |
...
| D4 | Continuous visual correction | V1 perception p95 1.938 mm; physical nominal/pushed live 2/12 and 3/12. V2 routing finishes another 48 cases: live 6/12 nominal and 5/12 pushed, frozen 2/12 and 1/12. Only one V2 seed passes both undisturbed controls. All outcomes packaged | Both candidates unpromoted. Broad reliability and visual correction after grasp remain open; any next experiment needs fresh seeds and a new budget |
