...
| D4 | Continuous visual correction | Frozen RGB experiment: perception p95 1.938 mm; physical nominal live 2/12, pushed live 3/12, pushed frozen 0/12. All 48 outcomes packaged; only one seed passes both undisturbed controls | Candidate not promoted. Broad reliability and visual correction after grasp remain open; any next experiment needs fresh seeds and a new budget |
...
| D6 | Two-arm handoff / complementary action | Learned table-supported bottle relay passes 5/5 frozen trials in each direction, with release/parking/contact checks | Integrate into the final demo and evidence video; retain precise relay description |
