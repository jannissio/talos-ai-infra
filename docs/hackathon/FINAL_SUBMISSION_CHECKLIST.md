...
| D3 | Broader bottle starting positions; robustness score 15 | Original direct model: 10/10 small-jitter, 1/3 wider. New learned right-to-left relay: 5/5 frozen trials in the farther-left region | Validate integration into the dinner workflow; retain finite-region scope and original failure evidence |
